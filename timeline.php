<section id="timeline-wrapper">
    ...
    <ul class="timeline-list">
        <li class="timeline-item">
            <span class="timeline-item-title timeline-item--naissance">Naissance</span>
        ...
        <li class="timeline-item">
            <span class="timeline-item-title timeline-item--etudes">Études</span>
        ...
        <li class="timeline-item">
            <span class="timeline-item-title timeline-item--famille">Famille</span>
        ...
        <li class="timeline-item">
            <span class="timeline-item-title timeline-item--retraite">Retraite</span>
        ...
        <li class="timeline-item">
            <span class="timeline-item-title timeline-item--deces">Décès</span>
